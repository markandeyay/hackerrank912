...
|---|---|---:|---:|---:|---:|---|---:|
| Anthropic | `claude-sonnet-5` | 503 | 599,088 | 50,933 | 650,021 | $2.00 / $10.00 | $1.7075 |

## Overall totals

- Model calls: **503**
- Input tokens: **599,088**
- Output tokens: **50,933**
- Total tokens: **650,021**
- Average tokens per request (250 requests): **2,600.1**
- Estimated total cost: **$1.7075**
- Estimated cost per request: **$0.00683**

## Calls by job

| Model | Job | Calls | Input tokens | Output tokens |
|---|---|---:|---:|---:|
| `claude-sonnet-5` | explanation_polish | 272 | 134,808 | 15,524 |
